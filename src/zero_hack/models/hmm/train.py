...
from zero_hack.models.hmm.model import HMMModel


def main() -> None:
    parser = argparse.ArgumentParser(description="Discrete-emission HMM next-step baseline.")
    ...
    parser.add_argument("--hidden-states", type=int, default=5)
