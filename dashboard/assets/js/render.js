(function () {
  ...
  function renderKPIs() {
    ...
    box.appendChild(kpi("Process-validity", 1.0, "LSTM completions · all valid", C.pct));
    box.appendChild(kpi("Anomaly ROC-AUC", 1.0, "classic detector · local eval", (x) => x.toFixed(2)));
  }
