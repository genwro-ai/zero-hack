...
├── industrial_de.md                       ← Full track briefing (German)
├── industrial_en.md                       ← Full track briefing (English)
│
└── ../../data/industrial/
...
- **English:** [`industrial_en.md`](./industrial_en.md)
- **Deutsch:** [`industrial_de.md`](./industrial_de.md)
...
uv run python data/industrial/generate_sequences.py --family mosfet --count 2000 --output outputs/extra_mosfet.csv --seed 42
...
uv run python data/industrial/generate_sequences.py --family igbt --estimate-only
```
...
**[`data/industrial/generation_rules.md`](../../data/industrial/generation_rules.md)** is the authoritative reference. It documents:
...
| ------------------------------------------------------------------------------ | ------------------------------------------- |
| [`industrial_en.md`](./industrial_en.md)                                       | Full English track briefing                 |
| [`industrial_de.md`](./industrial_de.md)                                       | Full German track briefing                  |
| [`data/industrial/README.md`](../../data/industrial/README.md)                 | Data & eval quickstart                      |
| [`data/industrial/generation_rules.md`](../../data/industrial/generation_rules.md) | Grammar, forbidden patterns & eval protocol |
| [`data/industrial/generate_sequences.py`](../../data/industrial/generate_sequences.py) | Generator & validator CLI reference         |
